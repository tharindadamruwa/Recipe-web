...
(async function() {
  ...
  for (let i = 1; i < categories.length; i++) {
    ...
    div.addEventListener("click", function() {
      ...
      getRecipesOfCatagoty(categories[i].strCategory);
...
async function getRecipesOfCatagoty(catagory) {
  try {
    ...
    for (let i = 0; i < recipes.length; i++) {
      ...
      div.addEventListener("click", function() {
        ...
        showFullResipe(recipes[i].idMeal);
...
async function showFullResipe(recipeId) {
